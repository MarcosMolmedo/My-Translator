...
const PreguntasFrecuentes = () => {
  ...
  const preguntas = [
    ...
    },
    {
      ...
      respuesta: (
        <div>
          ...
          <ul>
            <li><strong>Las traductoras juradas en Países Bajos NO tenemos firma digital y por lo tanto NO estamos autorizadas a realizar traducciones digitales.</strong></li>
            <li><strong>Realizamos la traducción, la imprimimos, sellamos y firmamos manualmente.</strong></li>
            <li><strong>Lo que sí puedo enviarte es una versión escaneada de la traducción impresa.</strong></li>
            <li><strong>Para algunos trámites se aceptan estas versiones escaneadas, pero lo válido es la impresa.</strong></li>
            <li><strong>Podés pasar a buscarla por mi oficina, o puedo enviártela por correo (10 euros + IVA aprox).</strong></li>
          </ul>
        </div>
      ),
    },
    ...
    },
    {
      ...
      respuesta: (
        <div>
          <p><strong>Nunca me ha pasado, pero si llegara a ocurrir:</strong></p>
          <ul>
      ...
      respuesta: (
        <div>
          <ul>
            ...
            <li><strong>Si la institución requiere certificación extra, mejor confirmarlo antes con la entidad.</strong></li>
          </ul>
        </div>
      ),
    },
